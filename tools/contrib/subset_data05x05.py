...
def main ():
    ...
    if (args.run_type == "point"):
        ...
        dir_clm_forcedata='/cluster/shared/noresm/inputdata/atm/datm7/'
        ...
        #--  Set input and output filenames
        #--  Specify input and output directories
        dir_output='/cluster/projects/nn2806k/dev/region/'
        if ( not os.path.isdir( dir_output ) ):
            os.mkdir( dir_output )
        ...
        fdomain_out = dir_output + 'domain.lnd.360x720_tx0.1v3.210506.'+region.tag+'.nc'
...
#        fdomain_out = dir_output + 'domain.lnd.fv1.9x2.5_gx1v7.'+region.tag+'_170518.nc'
        ...
        fsurf_out   = dir_output + 'surfdata_360x720cru_16pfts_Irrig_CMIP6_simyr1850_c170824'+region.tag+'.nc'
